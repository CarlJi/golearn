...
import (
	...
	"carlji.com/experiments/gocover/go1.10.2/pkg/buildid"
	"carlji.com/experiments/gocover/go1.10.2/pkg/cache"
...
// used by the build artifact cache (see carlji.com/experiments/gocover/go1.10.2/pkg/cache), but
